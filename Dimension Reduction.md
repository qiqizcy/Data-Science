...
```
> 2.5 -2.8 are the methods which suit for non-linear data processing, and t-SNE is more visualized than ISOMAP, UMAP also suits for high dimensions data and faster than t-SNE. ALL the four methods  capture the manifold structure data.
